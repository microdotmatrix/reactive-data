...
export function CartProvider({ children }) {
  ...
  async function addToCart(newItem) {
    ...
    if (cart.length === 0) {
      ...
      const response = await client.checkout.addLineItems(lineItems, newItem)
      ...
      await client.checkout.updateLineItems(newCartWithItem, checkoutId)
  ...
  async function updateCartItemQuantity(id, quantity) {
    ...
    await client.checkout.updateLineItems(newCart, checkoutId)
